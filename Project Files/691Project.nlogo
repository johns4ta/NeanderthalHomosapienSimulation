...
;
;
;Turtles need to stay at food places until they are completely full. Currently, they stay there until they reach just over 20, the threshold
;
...
globals[MAX_HUNGER_LEVEL MAX_THIRST_LEVEL FOOD_STORAGE_CAPACITY deathsFromOldAge deathsFromStarvation deathsFromDehydration numberNeandsAlive]
breed[people person]
breed[foods food]
breed[waters water]
breed[homes hme]
...
to createNeanderthal
    ...
    ask target[set targetX xcor set targetY ycor]
...
to reproduce ;; wolf procedure
  if random-float 1000 < 1 [  ;; throw "dice" to see if you will reproduce
...
to getAliveCounts
  ...
  ask people[
   set numberNeandsAlive numberNeandsAlive + 1
  ]
end
...
"" ""
PENS
"pen-1" 1.0 0 -13840069 true "" "plot numberNeandsAlive"
